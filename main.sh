...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[92;1m              𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 ITCHYFINGERS SCRIPT               \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/harryke254/Itchy.V.1.git/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Cloder07/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Cloder07/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/harryke254/Itchy.V.1.git/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/harryke254/Itchy.V.1.git/main/Cfg/m-noobz 
