...
cd /usr/bin
wget https://raw.githubusercontent.com/harryke254/Itchy.V.1.git/main/Bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
cd
wget https://raw.githubusercontent.com/harryke254/Itchy.V.1.git/main/Bot/kyt.zip
unzip kyt.zip
cp -r kyt /usr/bin/
cd /usr/bin
